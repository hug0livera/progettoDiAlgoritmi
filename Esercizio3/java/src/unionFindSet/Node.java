...
public class Node<T> {
   ...
   * @param parent    Father of the nodes, if there's only one element then it points at itself
  ...
  /**
   * 
   * @return    Returns the father of the node, if there's only one element
   * it returns itself
   */
